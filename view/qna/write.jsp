...
<form id="writeForm" name="writeForm" action="write.do" method="post" >
<input name="${_csrf.parameterName}" type="hidden" value="${_csrf.token}"/>
<input type="hidden" style="display: inline;" name="writerEmail" value="${emails}"/>
...
<tbody>
	...
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">email</span><input type="text" style="display: inline;" name="email" size="70.3" value="${emails}" readonly/></td>
	</tr>
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">글쓴이</span><input type="text" style="display: inline;" name="writer" size="70.3" value="${emails}" readonly/></td>
	</tr>
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">제목</span><input type="text" style="display: inline;" name="subject" size="72"/></td>
	</tr>
	<tr>
		<td colspan="2" align="center">
	    	<div class="detail"><div class="fr-view fr-view-article"><p><textarea type="text" name="content" rows="15" cols="70"></textarea></p></div></div>
	    </td>
    </tr>
</tbody>
</table>
...
function check()
	   {
	       for(var i=0; i<document.writeForm.elements.length; i++)
		   {
		      if(document.writeForm.elements[i].value == "")
			  {
