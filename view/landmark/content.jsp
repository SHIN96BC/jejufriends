...
<div id="wrap">
	...
	<tbody>
	<tr>
	<td class="board_subject" colspan="2">${landmark.lname } </td>
	                </tr>
			<tr>
	...
	<div style="width: 700px; height: 500px; margin-top: 40px; margin-left: 290px;">
		<div >
			<img src='/photo/${landmark.lphoto }'  border="0" alt=""  style="width: 100%; height: 500px;"/>
			<!--  
			...
			<div class="store_name" id="storeMain">
				...
				<div class="addBox">
					<dl class="add">
						...
						<dd id="storeAddressTxt">${landmark.laddress} </dd>
					</dl>
					<dl class="num">
						<dt id="storeTelTitle">전화번호</dt>
						<dd id="storeTelTxt">${landmark.lphone}</dd>
					</dl>
				...
				<div class="menu_link"><!--180831 추가-->
					<ul>
						...
						<li><a href="#storeTotMenu" class="scrolling" id="menuInfo">관광지안내</a></li> <!-- MSG : 메뉴안내 --> <!-- fnInitMctIf 에서 메뉴/입장료 분기 처리 -->
						<li><a href="#storeInfo" class="scrolling" id="storeTitInfo">관광지소개</a></li> <!-- MSG : 맛집소개 -->
				...
				<div class="store_map" id="storeTotMenu">
					<dl class="store_view">
                     <dt id="storeTotMenuTitle">관광지<input type="hidden" name="41"><input type="hidden" name="42"><input type="hidden" name="43"></dt>
                     <dd>
               ...
               <h2 class="s_tit" id="storeInfoTitle">관광지소개</h2> 
               <h3 class="s_tit2" id="storeInfoTxt1">${landmark.lintro}</h3>
               <p class="con_txt" id="storeInfoTxt2">${landmark.lintro2 }</p>
               <dl class="store_view" id="storeTimeFrame" style="display: block;">
                  ...
                  <dd>
                     <div class="row" id="workingTimeFrame" style="display: block;">
                        ...
                        <dd style="margin-top: -20px;">${landmark.lopcl}</dd>
...
<div class="xans-element- xans-board xans-board-list-3001 xans-board-list xans-board-3001"><!--
        ...
        -->
<div id="storeReview">
<c:forEach items="${landmarkreviewVo}" var="LandmarkreviewVo">
<c:if test="${not empty landmarkreviewVo}">
		...
		<ul class="boardComment">
			<li class="first  xans-record-">
                <div class="commentTop">
                    <strong class="name">
                    <a href='#none' onclick=EC_BOARD_ADMIN.member_info('rlgh2587','rlgh2587');>${LandmarkreviewVo.writer }</a></strong>
                    <span class="date"> <fmt:formatDate value="${LandmarkreviewVo.rdate }" pattern="yyyy-MM-dd (E) HH:mm" /></span>
                ...
                <span class="button">
                    ...
                    <a href="del.do?lrnum=${LandmarkreviewVo.lrnum }&lnum=${landmark.lnum}" class="btnNormal"><i class="icoDelete"></i> 삭제</a>
                </span>
                <div class="comment">
                    <span class="displaynone"><img src="//img.echosting.cafe24.com/skin/base/board/ico_spam.gif" alt="스팸글"/></span>
                     ${LandmarkreviewVo.content} 
               </div>
            </li>
        </ul>
	</div>
...
<div class="xans-element- xans-board xans-board-commentwrite-1002 xans-board-commentwrite xans-board-1002 "><!-- 댓글권한 있음 -->
            <fieldset>
            <form id="commentWriteForm" name="f" action="review.do?lnum=${landmark.lnum }" method="post" target="_self"  >
            <input name="${_csrf.parameterName}" type="hidden" value="${_csrf.token}"/>
			<legend>댓글 입력</legend>
                <div class="input">
                    <strong>댓글달기</strong>
