					...
					<dl class="store_view">
                     ...
                     <dd>
                        ...
                        <div class="menu_box" id="menuFull">
                           <ul class="store_menu" id="storeTotMenuImg" style="display: block;"><li class="group" name="41">대표메뉴</li>
                           ...
                           <li><span><em>${food.fmenu3 }</em></span><span class="price">${food.fcost3 }원</span></li>
                           </ul>
                        </div>
                     </dd>
                   </dl>
