...
<div id="myshopMain" class="xans-element- xans-myshop xans-myshop-main"><ul>
        ...
        <li class="shopMain wishlist">
            <h3><a href="/jejufriends/wishlist/wishlist.do"><strong>Wishlist</strong><span>찜 목록</span></a></h3>
            <p><a href="/jejufriends/wishlist/wishlist.do">관심코스로 찜하신<br/> 코스의 목록을 보여드립니다.</a></p>
        </li>
