...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..RmsIUrim6mQzJZxmzT478eowBgbZHO-WsYAi_JZcLsQ","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.BOARD_FREE_DETAIL"});
    };
...
CAFE24.FRONT_JS_ARTICLES = {"13":{"no":13,"ucc_url":""}};
var EC_FRONT_JS_ARTICLES = CAFE24.getDeprecatedNamespace('EC_FRONT_JS_ARTICLES');
CAFE24.FRONT_JS_CONFIG_BOARD = {"iBoardNo":5,"sCommentWriterType":"N","sCommentUseId":"F"};
...
CAFE24.ROUTE = {"is_mobile":false,"is_need_route":false,"language_code":"ko_KR","path":{"origin":"\/article\/\uc790\uc720\uac8c\uc2dc\ud310\/5\/13\/","result":"\/article\/\uc790\uc720\uac8c\uc2dc\ud310\/5\/13\/","prefix":""},"shop_no":0,"skin_code":"default"};
</script>
...
<tbody>
<tr>
<td class="board_subject" colspan="2">ㅋㅋ</td>
                </tr>
<tr>
<td class="board_sub_text" colspan="2">
						 <a href='#none' onclick=EC_BOARD_ADMIN.member_info('rlgh2587','rlgh2587');>기호제학(rlgh2587)</a> <span class="displaynone">(ip:)</span> <span id="mileage_icon"></span>
...
<tr>
<td colspan="2">
                        <div class="detail"><div class="fr-view fr-view-article"><p>ㅋㅋ</p></div></div>
                    </td>
                </tr>
...
<li class="prev ">
<strong>이전글</strong><a href="/article/자유게시판/5/14/">ㅎㅇㅎㅇ</a>
</li>
        <li class="next displaynone">
<strong>다음글</strong><a href="/article/자유게시판/5/$3/"></a>
</li>
    </ul>
</div>
