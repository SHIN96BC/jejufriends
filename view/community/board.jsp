...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..YLi0v41e2kus1TlrrFm44uzTyLDlp9sfh1pq-93i5Rg","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.BOARD_FREE_LIST"});
    };
...
<meta name="design_html_path" content="/board/free/list.html" /></head><body>
...
<th scope="col"><input class="boardListAll" value="all" type="checkbox"  /> 번호</th>
...
<td><input class="boardChk" value="14" type="checkbox"  /> 2</td>
                    <td class="displaynone"></td>
                    <td class="subject left txtBreak">
                         <a href="/article/자유게시판/5/14/" style="color:#555555;">ㅎㅇㅎㅇ</a> <img src="http://img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_new.gif"  alt="NEW" class="ec-common-rwd-image" /><span class="txtEm"></span>
                    </td>
                    <td>기호제학</td>
                    <td class=""><span class="txtNum">2022-03-17</span></td>
...
<tr style="background-color:#FFFFFF; color:#555555;" class="xans-record-">
<td><input class="boardChk" value="13" type="checkbox"  /> 1</td>
                    <td class="displaynone"></td>
                    <td class="subject left txtBreak">
                         <a href="/article/자유게시판/5/13/" style="color:#555555;">ㅋㅋ</a> <img src="http://img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_new.gif"  alt="NEW" class="ec-common-rwd-image" /><span class="txtEm"></span>
                    </td>
                    <td>기호제학</td>
                    <td class=""><span class="txtNum">2022-03-17</span></td>
...
<div class="xans-element- xans-board xans-board-buttonlist-1002 xans-board-buttonlist xans-board-1002 ec-base-button typeBG  "><span class="gRight">
            <a href="/board/free/write.html?board_no=5" class="btnSubmitFix sizeS ">글쓰기</a>
        </span>
</div>
</div>

<div class="xans-element- xans-board xans-board-paging-1002 xans-board-paging xans-board-1002 ec-base-paginate"><a href="?board_no=5&page=1"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_prev.gif" alt="이전 페이지"/></a>
<ol>
...
<!-- //결제를 위한 필수 영역 -->
		...
		EC$(function() {
		EC$('.boardListAll').click(function() {
		if ( this.checked ) {
		EC$('.boardChk').prop('checked', true);
		} else {
		EC$('.boardChk').prop('checked', false);
		}
		});
		});
		EC$(function() {
		...
		var iBoardNo = "5";
		EC$(function(){
		FwValidator.bind("form_1303495760", false);
		});
