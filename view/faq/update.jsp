...
<tbody>
	<tr>
		<td class="board_subject"  colspan="2" align="center"><span style="padding-right: 10px;">제목</span><input type="text" style="display: inline;" name="subject" size="60" value="${faq.subject}"/></td>
	</tr>
	<tr>
		<td colspan="2" align="center">
	    	<div class="detail"><div class="fr-view fr-view-article"><p><textarea type="text" name="content" rows="15" cols="70">${faq.content}</textarea></p></div></div>
	    </td>
    </tr>
</tbody>
</table>
...
function check()
	   {
	       for(var i=0; i<document.updateForm.elements.length; i++)
		   {
