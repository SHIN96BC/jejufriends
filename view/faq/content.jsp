...
<html xmlns="//www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">
	<%
		/* session에 저장된 이메일을 가지고와서 수정/삭제 버튼 보여줄건지 체크 */
...
<tbody>
	<tr>
		<td class="board_subject" colspan="2">${faq.subject}</td>
	</tr>
	<tr>
		<td class="board_sub_text" colspan="2">
			<span class="">작성일 ${faq.rdate}</span>
			<span class="">조회수 ${faq.hits}</span>
		</td>
	</tr>
	<tr>
		<td colspan="2">
	    	<div class="detail"><div class="fr-view fr-view-article"><p>${faq.content}</p></div></div>
	    </td>
    </tr>
...
<div class="ec-base-button ">
            ...
            <span id="adminBox" class="gRight">
                <a href="del.do?seq=${faq.seq}" class="btnNormalFix sizeS ">삭제</a>
                <a href="update.do?seq=${faq.seq}" class="btnEmFix sizeS ">수정</a>
            </span>
        </div>
</div>
</form></div>
